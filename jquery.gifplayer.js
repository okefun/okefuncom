...
(function ($) {
    ...
    GifPlayer.prototype = {
        ...
        loadGif: function () {
            ...
            this.gifElement = $("<img class='gp-gif-element' width='100%' height='100%'/>");
        ...
        playVideo: function () {
            ...
            // Mobile devideo play() method need user interaction on video tags
	    if(this.videoElement[0].paused == true){
		this.pauseVideo();
	    }
