...
}), $(document).ready(function () { $(".gifplayer").gifplayer(), $(".gslider").slick({ focusOnSelect: !0, infinite: !1, centerMode: !0, centerPadding: "60px", initialSlide: 1, slidesToShow: 3, responsive: [{ breakpoint: 800, settings: { centerMode: !0, centerPadding: "40px", slidesToShow: 2, initialSlide: 1 } }, { breakpoint: 480, settings: { initialSlide: 0, centerMode: !0, centerPadding: "40px", slidesToShow: 1 } }] }); var e = document.getElementsByClassName("post-label"); if (e.length > 0) { var t = e[e.length - 1], n = t.innerHTML; n.indexOf("photo") >= 0 ? (null != document.getElementById("photoMenu") && (document.getElementById("photoMenu").className += " active"), null != document.getElementById("photoMenu-mobile") && (document.getElementById("photoMenu-mobile").className += " active")) : n.indexOf("gif") >= 0 ? (null != document.getElementById("gifMenu") && (document.getElementById("gifMenu").className += " active"), null != document.getElementById("gifMenu-mobile") && (document.getElementById("gifMenu-mobile").className += " active")) : (null != document.getElementById("homeMenu") && (document.getElementById("homeMenu").className += " active"), null != document.getElementById("homeMenu-mobile") && (document.getElementById("homeMenu-mobile").className += " active")) } else { var i = window.location.href; urlSergment = i.split("/"), urlSergment.length >= 3 && (-1 == i.indexOf("search/label/") ? (null != document.getElementById("homeMenu") && (document.getElementById("homeMenu").className += " active"), null != document.getElementById("homeMenu-mobile") && (document.getElementById("homeMenu-mobile").className += " active")) : "label" == urlSergment[4] && (urlSergment[urlSergment.length - 1].startsWith("photo") ? (null != document.getElementById("photoMenu") && (document.getElementById("photoMenu").className += " active"), null != document.getElementById("photoMenu-mobile") && (document.getElementById("photoMenu-mobile").className += " active")) : urlSergment[urlSergment.length - 1].startsWith("gif") ? (null != document.getElementById("gifMenu") && (document.getElementById("gifMenu").className += " active"), null != document.getElementById("gifMenu-mobile") && (document.getElementById("gifMenu-mobile").className += " active")) : (null != document.getElementById("homeMenu") && (document.getElementById("homeMenu").className += " active"), null != document.getElementById("homeMenu-mobile") && (document.getElementById("homeMenu-mobile").className += " active")))) } });